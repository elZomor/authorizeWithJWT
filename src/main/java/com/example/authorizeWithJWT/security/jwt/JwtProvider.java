package com.example.authorizeWithJWT.security.jwt;
...
public class JwtProvider{
     ...
     * @return jwt string
     */
    public String createToken(String username, List<RoleGroup> roles) {
        ...
        claims.put(ROLES_KEY, roles.stream().map(role ->new SimpleGrantedAuthority(role.getRole()))
